...
def parse_option():
    ...
    parser.add_argument('--cfg', type=str, default='./cfgs/fsa_deit_s.yaml', metavar="FILE", help='path to config file', )
    parser.add_argument(
        "--opts",
        help="Modify config options by adding 'KEY VALUE' pairs. ",
        # default=['MODEL.NAME', 'example',
        #          'MODEL.FSA.VERSION', 1,
        #          'MODEL.FSA.ATTN_TYPE', 'BBBB',
        #          'DATA.IMG_SIZE', reso,
...
if __name__ == '__main__':
    ...
    # ---------- 可视化等 ----------
    # model.load_state_dict(torch.load('./fsa_deit_t.pth')['model'])
    # model.eval()
